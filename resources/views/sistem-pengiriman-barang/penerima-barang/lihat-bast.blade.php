...
<div class="col-sm-12">
      <div class="box">
        <div class="box-header">
          <h2>List BAST</h2>
          <small>
            Berikut adalah list BAST yang telah anda pilih.
          </small>
          </small>
        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengiriman-barang/penerima-barang/lihat-detail-bast-penerima-barang-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
  ...
  <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/penerima-barang/lihat-bast"><button class="btn btn-block success">Refresh</button></a>
  </br>
</div>
