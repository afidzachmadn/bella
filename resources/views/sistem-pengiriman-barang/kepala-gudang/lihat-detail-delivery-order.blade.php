...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/kepala-gudang/lihat-delivery-order">Lihat delivery order</a></li>
...
<div class="padding">
  <div class="col-sm-12">
    ...
    <div class="box padding printableArea">
      ...
      <p style="margin-left:5px;">D. Unkepala-gudangk menyerahkan dari persediaan kepada : xxxxx</p>
      ...
      <p style="margin-left:5px;">D. Harga sakepala-gudangan (Rp) : xxxxx</p>
      <p style="margin-left:5px;">E. Jumlah sakepala-gudangan (Rp) : xxxxxx</p>
      <p style="margin-left:5px;">F. Keterangan : xxxxxxxx</p>
      <p>5. SPPB ini berlaku sampai tanggal : xxxxxx</p>
      <p>6. Dengan ketenkepala-gudangan :</p>
      <p style="margin-left:5px;">A. Penyerahan xxxxx dengan netto unkepala-gudangk netto diatas alat angkut dimuka pinkepala-gudang kepala-gudang.</p>
      <p style="margin-left:5px;">B. Hanya SPPB asli yang berlaku unkepala-gudangk pengeluaran barang tersebut.</p>
      <p style="margin-left:5px;">C. Jika terdapat perubahaan/tambahan dari ketenkepala-gudangan yang tertera di dalam SPPB ini, maka SPPB ini dinyatakan batal/tidak sah.</p>
      </div>
