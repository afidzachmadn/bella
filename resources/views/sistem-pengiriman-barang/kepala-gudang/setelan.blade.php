  ...
  <div class="col-sm-9 col-lg-10 light bg">
    <div class="tab-content pos-rlt">
      <div class="tab-pane active" id="tab-1">
        ...
        <form role="form" class="p-a-md col-md-6" action="{{url('/sistem-pengiriman-barang/kepala-gudang/setelan-kepala-gudang-proses')}}" method="post" enctype="multipart/form-data">
          {{ csrf_field() }}
