...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/kepala-gudang/lihat-delivery-order">Lihat BAST</a></li>
...
<div class="padding printableArea">
  <div class="col-sm-12">
    <div class="box">
      ...
      <p> Unkepala-gudangk selanjutnya PIHAK PERTAMA dan PIHAK KEDUA secara bersama sama disebut para pihak.</p>
      <p>Berdasarkan:</p>
      ...
      b. Jumlah kuankepala-gudangm : xxxx </br>
