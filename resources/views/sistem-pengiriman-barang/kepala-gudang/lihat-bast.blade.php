...
<div class="col-sm-12">
        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengiriman-barang/kepala-gudang/lihat-detail-bast-kepala-gudang-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
  ...
  <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/kepala-gudang/lihat-bast"><button class="btn btn-block success">Refresh</button></a>
  </br>
</div>
