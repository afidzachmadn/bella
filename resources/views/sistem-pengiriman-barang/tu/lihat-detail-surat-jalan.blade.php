...
<div class="m-b">
		...
		<ol class="breadcrumb">
			...
			<li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/tu/input-delivery-order">Input delivery order</a></li>
      <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/tu/input-delivery-order/lihat-delivery-order">Lihat detail surat jalan</a></li>
