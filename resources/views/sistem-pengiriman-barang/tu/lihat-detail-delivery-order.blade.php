...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/tu/lihat-delivery-order">Lihat delivery order</a></li>
...
<div class="padding">
  <div class="col-sm-12">
    ...
    <div class="box padding printableArea">
      ...
      <p style="margin-left:5px;">A. Penyerahan xxxxx dengan netto untuk netto diatas alat angkut dimuka pintu tu.</p>
