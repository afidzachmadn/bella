...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/transportasi/input-surat-jalan">Input surat jalan</a></li>
...
<div class="col-sm-12">
      <div class="box">
        <div class="box-header">
          ...
          <small>
            Berikut adalah list surat jalan yang dapat anda lihat.
          </small>
        </div>
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengiriman-barang/transportasi/lihat-detail-surat-jalan-transportasi-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
  ...
  <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/transportasi/lihat-surat-jalan"><button class="btn btn-block success">Refresh</button></a>
  </br>
</div>
<!-- ############ PAGE END ###################-->
