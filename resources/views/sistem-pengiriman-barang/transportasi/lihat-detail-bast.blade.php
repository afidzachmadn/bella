...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengiriman-barang/transportasi/lihat-bast">Lihat BAST</a></li>
...
<div class="padding printableArea">
  <div class="col-sm-12">
    <div class="box">
      ...
      <p> Untransportasik selanjutnya PIHAK PERTAMA dan PIHAK KEDUA secara bersama sama disebut para pihak.</p>
      <p>Berdasarkan:</p>
      ...
      b. Jumlah kuantransportasim : xxxx </br>
