...
<head>
  ...
  <meta name="apple-mobile-web-app-stakepala-gudangs-barstyle" content="black-translucent">
...
<!-- ############ LAYOUT START-->
  ...
  <!-- aside -->
  <div id="aside" class="app-aside fade nav-dropdown brown-500">
    <!-- fluid app aside -->
      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/kepala-gudang/dashboard" class="b-danger">
              ...
              <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/kepala-gudang/lihat-delivery-order" >
                      <span class="nav-text">Lihat Delivery Order</span>
                    </a>
                  </li>
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/kepala-gudang/lihat-bast" >
