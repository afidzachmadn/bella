...
<head>
  ...
  <meta name="apple-mobile-web-app-statransportasis-barstyle" content="black-translucent">
      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/transportasi/dashboard" class="b-danger">
              ...
              <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/transportasi/lihat-surat-jalan" >
                      <span class="nav-text">Surat Jalan</span>
                    </a>
                  </li>
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pengiriman-barang/transportasi/lihat-bast" >
