        ...
        <div class="col-sm-7">
          <a href="#" class="pull-left m-r-md">
            <span class="avatar w-96">
              <img src="{{env('APP_URL')}}/plugins/images/assets/studio10.jpg">
              <i class="on b-white"></i>
            </span>
          </a>
          <div class="clear m-b">
            <h4 class="m-a-0 m-b-sm">Florencia Agnesia Myskowsky</h4></br>
            <p class="text-muted"><span class="m-r"><i class="material-icons md-24">email</i>&nbsp<b>alexandra@gmail.com</b></span>
            </p>
