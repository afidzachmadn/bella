          ...
          <div class="col-sm-4 push-sm-4">
            <div class="box m-t-n">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah surat perintah yang masuk
                  </div>
                </li>
              </ul>
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/korlap/lihat-surat-perintah" class="btn btn-block btn-lg primary">Lihat</a>
              </div>
            </div>
          </div>
          <div class="col-sm-4 pull-sm-4">
            <div class="box">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah surat print-log yang masuk
                  </div>
                </li>
              </ul>
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/korlap/lihat-printlog" class="btn btn-block btn-lg success">Lihat</a>
              </div>
            </div>
          </div>
          <div class="col-sm-4">
            <div class="box">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah surat BAST yang masuk
                  </div>
                </li>
              </ul>
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/korlap/lihat-bast" class="btn btn-block btn-lg danger">Lihat</a>
              </div>
            </div>
          </div>
        </div>
