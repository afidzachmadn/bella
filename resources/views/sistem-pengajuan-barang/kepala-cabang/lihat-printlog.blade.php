...
<div class="col-sm-12">
      <div class="box">
        <div class="box-header">
          <h2>List Printlog Pengadaan Barang</h2>
          <small>
            Berikut adalah list printlog pengadaan barang yang telah di input oleh TU, untuk melihatnya silahkan klik tombol Lihat.
          </small>
        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            ...
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengajuan-barang/kepala-cabang/lihat-detail-printlog-kepala-cabang-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
              <p class="text-center">{{$CekList -> nomor}}</p>
              <input style="visibility:hidden" type="text" class="form-control text-center" id="exampleInputEmail1" required="" name="nomor_surat" value="{{$CekList -> nomor }}"></td>
  ...
  <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/kepala-cabang/lihat-printlog"><button class="btn btn-block success">Refresh</button></a>
  </br>
</div>
