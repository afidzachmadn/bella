...
<div class="col-sm-12">
      <div class="box">
        <div class="box-header">
          ...
          <small>
            Berikut adalah list printlog pengadaan barang yang telah di inputkan oleh TU di sistem ini.
          </small>
        </div>
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center"><a href="{{env('APP_URL')}}/sistem-pengajuan-barang/kepala-cabang/lihat-printlog/lihat-detail-printlog"><button class="btn btn-block danger">Lihat</button></td>
