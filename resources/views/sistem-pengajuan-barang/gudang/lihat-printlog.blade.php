        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center"><a href="{{env('APP_URL')}}/sistem-pengajuan-barang/gudang/lihat-printlog/lihat-detail-printlog"><button class="btn btn-block danger">Lihat</button></td>
