...
<div class="col-sm-12">
        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            ...
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengajuan-barang/gudang/lihat-detail-bast-korlap-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
  ...
  <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/gudang/lihat-bast"><button class="btn btn-block success">Refresh</button></a>
  </br>
</div>
