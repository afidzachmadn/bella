  ...
  <div id="content" class="app-content box-shadow-z2 bg pjax-container" role="main">
    <div class="app-header white bg b-b">
          <div class="navbar" data-pjax>
                ...
                <div class="navbar-item pull-left h5" id="pageTitle">Lihat Surat Perintah</div>
                <!-- nabar right -->
...
<div class="col-sm-12">
        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            ...
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengajuan-barang/gudang/lihat-detail-surat-perintah-gudang-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
  ...
  <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/gudang/lihat-surat-perintah"><button class="btn btn-block success">Refresh</button></a>
  </br>
</div>
