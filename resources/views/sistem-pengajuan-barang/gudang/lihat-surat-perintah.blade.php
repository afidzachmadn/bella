        ...
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <td class="text-center"><a href="{{env('APP_URL')}}/sistem-pengajuan-barang/gudang/lihat-surat-perintah/lihat-detail-surat-perintah"><button class="btn btn-block danger">Lihat</button></td>
