...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengajuan-barang/tu/input-bast">Input BAST</a></li>
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-pengajuan-barang/tu/input-bast/lihat-bast">Lihat BAST</a></li>
            <li class="breadcrumb-item active"><a href="{{env('APP_URL')}}/sistem-pengajuan-barang/tu/lihat-bast/lihat-detail-bast">Lihat detail BAST</a></li>
		</ol>
...
<div class="padding printableArea">
  <div class="col-sm-12">
    <div class="box">
      ...
      <p>2. {{$isi -> pihak_kedua}} jabatan {{$isi -> pihak_kedua}} bertindak dan atas nama Perum BULOG subdivre Wilayah I Semarang, selanjutnya disebut pihak kedua.</p>
      ...
      <p>a. Jenis barang :&nbsp&nbsp&nbsp{{$isi -> jenis_barang}}</br>
      b. Jumlah kuantum : &nbsp&nbsp&nbsp{{$isi -> jumlah_kuantum}} </br>
      c. Tanggal penyerahan : &nbsp&nbsp&nbsp{{$isi -> tanggal_penyerahan}}</br>
      d. Alat angkut : &nbsp&nbsp&nbsp{{$isi -> alat_angkut}} </br>
      </p>
