...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Input surat perintah</li>
		</ol>
...
<div class="box">
        <div class="box-header">
          <h2>Input Surat Perintah (Inang)</h2>
          <small>Isi form dibawah ini sesuai dengan surat perintah yang di terbitkan oleh BULOG</small>
        </div>
        <div class="box-divider m-a-0"></div>
        <div class="box-body">
          <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengajuan-barang/tu/input-surat-perintah-tu-proses')}}" method="post">
          {{ csrf_field() }}
            <div class="form-group">
              <label for="exampleInputEmail1">No</label>
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukan nomor surat" required="" name="nomor_surat">
            </div>
      ...
      <div class="col-sm-12">
         <a href="{{env('APP_URL')}}/sistem-pengajuan-barang/tu/input-surat-perintah/lihat-surat-perintah"><button class="btn btn-block danger">Lihat surat perintah</button></a>
      </div>
