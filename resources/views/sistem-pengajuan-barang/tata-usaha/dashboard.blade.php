          ...
          <div class="col-sm-4 push-sm-4">
            <div class="box m-t-n">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah surat perintah yang kamu kirimkan
                  </div>
                </li>
              </ul>
          ...
          <div class="col-sm-4 pull-sm-4">
            <div class="box">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah surat print-log yang kamu kirimkan
                  </div>
                </li>
              </ul>
              <div class="text-center p-a-md">
          ...
          <div class="col-sm-4">
            <div class="box">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah surat BAST yang kamu kirimkan
                  </div>
                </li>
              </ul>
              <div class="text-center p-a-md">
