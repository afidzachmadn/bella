    ...
    <div class="navbar">
      <div class="pull-center">
        ...
        <a href="index.html" class="navbar-brand">
        	...
        	<span class="hidden-folded inline"><h3>Sistem Pengajuan Barang</h3></span>
        </a>
        <!-- / brand -->
      </div>
    </div>
  ...
  <div class="b-t">
    <div class="center-block w-xxl w-auto-xs p-y-md text-center">
      <div class="p-a-md">
        ...
        <form class="form-horizontal form-material" id="loginform" action="{{url('/sistem-pengajuan-barang/login-proses')}}" method="post">
          {{ csrf_field() }}
          ...
          <div class="m-b-md">        
            <label class="md-check">
              <input type="checkbox"><i class="primary"></i> Ingat saya
            </label>
          </div>
          <button type="submit" class="btn btn-lg black p-x-lg">Masuk</button>
        </form>
        <div class="m-y">
          <a href="#" class="_600">Lupa Password?</a>
        </div>
        <div>
          Tidak punya akun? 
          <a href="#" class="text-primary _600">Daftar</a>
        </div>
      </div>
    </div>
  </div>

  <div class="app-footer pink-500 bg p-a b-t">
