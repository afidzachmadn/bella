        ...
        <div class="row no-gutter">
          <div class="col-sm-6 push-sm-6">
            <div class="box m-t-n">
              ...
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/tu/lihat-bast" class="btn btn-block btn-lg primary">Lihat</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 pull-sm-6">
            <div class="box m-t-n">
              ...
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/tu/input-laporan-kegiatan/lihat-laporan-kegiatan" class="btn btn-block btn-lg primary">Lihat</a>
              </div>
            </div>
          </div>
