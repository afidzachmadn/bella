...
<head>
  ...
  <meta name="apple-mobile-web-app-stakorlaps-barstyle" content="black-translucent">
    ...
    <div class="navside dk" data-layout="column">
      <div class="navbar no-radius">
        ...
        <a href="index.html" class="navbar-brand">
        	...
        	<span class="hidden-folded inline">SP</span>
        </a>
        <!-- / brand -->
      </div>
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/korlap/dashboard" class="b-danger">
              ...
              <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  ...
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/korlap/input-laporan-kegiatan" >
                      <span class="nav-text">Input Laporan Kegiatan</span>
                    </a>
                  </li>
              ...
              <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  ...
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/korlap/lihat-bast" >
