...
<head>
  ...
  <meta name="apple-mobile-web-app-stakepala-cabangs-barstyle" content="black-translucent">
...
<!-- ############ LAYOUT START-->
  ...
  <!-- aside -->
  <div id="aside" class="app-aside fade nav-dropdown pink-500">
    <!-- fluid app aside -->
    <div class="navside dk" data-layout="column">
      <div class="navbar no-radius">
        ...
        <a href="index.html" class="navbar-brand">
        	...
        	<span class="hidden-folded inline">SPIB</span>
        </a>
        <!-- / brand -->
      </div>
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/kepala-cabang/dashboard" class="b-danger">
              ...
              <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  ...
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/kepala-cabang/lihat-laporan-kegiatan" >
                      <span class="nav-text">Lihat Laporan Kegiatan</span>
                    </a>
                    <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/kepala-cabang/lihat-bast" >
