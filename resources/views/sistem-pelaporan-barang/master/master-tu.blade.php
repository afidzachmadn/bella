      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/tu/dashboard" class="b-danger">
              ...
              <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  ...
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/tu/lihat-laporan-kegiatan" >
                      <span class="nav-text">Lihat Laporan Kegiatan</span>
                    </a>
                    <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/tu/lihat-bast" >
