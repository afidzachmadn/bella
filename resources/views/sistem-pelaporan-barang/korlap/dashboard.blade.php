          ...
          <div class="col-sm-6 push-sm-6">
            <div class="box m-t-n">
              ...
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/korlap/lihat-bast" class="btn btn-block btn-lg primary">Lihat</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 pull-sm-6">
            <div class="box m-t-n">
              ...
              <ul class="list b-t b-b m-a-0 no-radius">
                ...
                <li class="list-item">
                  <div class="list-body">
                    <i class="text-danger m-r-xs"></i> Jumlah laporan kegiatan yang kamu inputkan
                  </div>
                </li>
              </ul>
              <div class="text-center p-a-md">
                <a href="{{env('APP_URL')}}/sistem-pelaporan-barang/korlap/input-laporan-kegiatan/lihat-laporan-kegiatan" class="btn btn-block btn-lg primary">Lihat</a>
              </div>
            </div>
          </div>
