...
<div class="m-b">
		...
		<ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{env('APP_URL')}}/sistem-keuangan-barang/keuangan/input-penagihan">Input surat penagihan</a></li>
...
<div class="col-sm-12">
      <div class="box">
        <div class="box-header">
          ...
          <small>
            Berikut adalah list surat penagihan yang telah anda inputkan, untuk mengeditnya silahkan klik tombol edit yang ada di bawah tabel.
          </small>
        </div>
        <table class="table table-striped b-t">
          ...
          <tbody>
            <tr>
              ...
              <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-keuangan-barang/keuangan/lihat-detail-surat-penagihan-keuangan-proses')}}" method="post">
              {{ csrf_field() }}
              <td>
  ...
  <div class="modal-dialog" id="animate">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-lg">
       <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-keuangan-barang/keuangan/edit-surat-penagihan-keuangan-proses')}}" method="post">
        {{ csrf_field() }}
...
<div id="m-a-b" class="modal fade animate" data-backdrop="true">
  <div class="modal-dialog" id="animate">
    <div class="modal-content">
      ...
      <div class="modal-body text-center p-lg">
       <form role="form" class="form-horizontal form-material" id="loginform" action="{{url('/sistem-keuangan-barang/keuangan/hapus-surat-penagihan-keuangan-proses')}}" method="post">
        {{ csrf_field() }}
            <div class="form-group">
