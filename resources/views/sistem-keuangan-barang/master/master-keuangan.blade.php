      ...
      <div data-flex class="hide-scroll">
          <nav class="scroll nav-stacked nav-stacked-rounded nav-color">
            ...
            <ul class="nav" data-ui-nav>
              ...
              <li>
                <a href="{{env('APP_URL')}}/sistem-keuangan-barang/keuangan/dashboard" class="b-danger">
            ...
            <li>
                ...
                <ul class="nav-sub nav-mega nav-mega-3">
                  ...
                  <li>
                    <a href="{{env('APP_URL')}}/sistem-keuangan-barang/keuangan/input-surat-penagihan" >
                      <span class="nav-text">Input Surat Penagihan</span>
                    </a>
                  </li>
